...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_UI_ViewModel_Crosshair);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_UI_ViewModel_HUD);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_UI_ViewModel_Interaction);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_UI_ViewModel_LockOn);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_UI_ViewModel_Upgrade);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_UI_ViewModel_EnemyStatus);
